                ...
                <?php if (!empty($data)): ?>
                    ...
                    foreach ($data as $notif): ?>
                        <tr>
                            ...
                            <!-- <td><span class="badge badge-info">Menunggu Verifikasi</span></td> -->
                            <td>
                            <?php
                            if ($notif['status'] == 'Menunggu Verifikasi') {
                                echo '<span class="badge badge-info">Menunggu Verifikasi</span>';
                            } elseif ($notif['status'] == 'Penugasan ke Kelurahan') {
                                echo '<span class="badge badge-info">Penugasan ke Kelurahan</span>';
                            }
                            ?>
                        </td>
                            ...
                            <td>
                                <a class="btn btn-success" href="<?php base_url() ?>/admin_kelurahan/notifikasi/detail/<?= $notif['kode_laporan'] ?>">Detail</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
